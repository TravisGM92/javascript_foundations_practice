...
describe('Shop', function() {
  ...
  it('cannot outfit a ship without a captain', function() {
    ...
    assert.equal(result, `cannot outfit a ship without a captain`); //captain was spelled wrong. It was spelled 'captian'
  });

  it('should not be able to outfit a ship if the captain is broke', function() {
    var captain = new Being('Will', 'human'); //captain spelled wrong

    var fighter = new Ship(
      {
        name: 'Atlantis',
        type: 'military',
        captain: captain, //captain spelled wrong again, this time on both. Spelled 'captian'
        maxCrew: 2,
        odometer: 3340,
      }
    )
...
//captain spelled wrong in description below
    ...
    var fighter = new Ship(
      {
        name: 'Atlantis',
        type: 'military',
        captain: captain, //captain spelled wrong
        maxCrew: 2,
        odometer: 3340,
      }
    );
